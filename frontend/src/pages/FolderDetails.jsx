...
const FolderDetail = () => {
  ...
  useEffect(() => {
    if (currentFolder) {
      setVideos(currentFolder.videos);
    }
  ...
  useEffect(() => {
    if (videos.length) setCurrentVideo(videos?.[0]);
  }, [videos]);
  ...
  return (
    <>
      ...
      <Box className="py-8 bg-secondary text-primary-text max-w-full">
            ...
            <Grid item xs={12} sm={4}>
              <div className="h-full custom-input">
                ...
                <Typography className="flex mt-3 text-xs text-secondary-text">
                  * Notes are only intended to be stored temporarily. If you
                  want your notes saved please enter them Asana. Contact Virgin
                ...
                <CardContent>
                  ...
                  <Grid className="mt-3">
                    <Typography className="flex text-xs">
                      <span>
                        <p>
                          * Please refer to your Training Manual for more File
                          downloads and supported documents. Contact Virgin
                          Janitorial if you need help
                        </p>
                      </span>
                    </Typography>
